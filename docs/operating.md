...
Keeping anthroxy running unattended, and finding out what happened when a request did not go the way it should.
...
The console's Requests tab shows most of this without a terminal; see [The web console](console.md).
